...
public class MainActivity extends AppCompatActivity {
    ...
    private void fillData() {
        ...
        String[] arJudul = recources.getStringArray(R.array.place_desc);
        String[] arDeskripsi = recources.getStringArray(R.array.place_desc);
        TypedArray a = recources.obtainTypedArray(R.array.places_picture);
